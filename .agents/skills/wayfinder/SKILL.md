---
name: wayfinder
description: "把超出单次会话的大型模糊工作规划为决策任务地图，并逐步消除关键不确定性。 English: Plan a huge chunk of work (more than one agent session can hold) as a shared map of decision tickets on your issue tracker, and resolve them one at a time until the way to the destination is clear."
