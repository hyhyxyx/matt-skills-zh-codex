...
description: "编写或修改供智能体读取的技能、AGENTS.md、CLAUDE.md及其引用文档。 English: Writing documents for agents. Use when creating or editing skills, or modifying AGENTS.md or CLAUDE.md."
---
